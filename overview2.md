...
The following process should be repeated for each book on the PPMC 

1. For each book, navigate to "https://admin.reading-space.com/activities/[book\_id]/picture-multiple-choice/create", where "book\_id" is the value in the "book\_id" column of the PPMC sheet
